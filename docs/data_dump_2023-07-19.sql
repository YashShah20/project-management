...
COPY public.users ("userId", "firstName", "lastName", "userName", email, password, "createdBy", "createdAt", "lastModifiedBy", "lastModifiedAt", "isAdmin", "passwordResetToken") FROM stdin;
2	System Admin	\N	admin	admin@gmail.com	$2b$10$LDwWQI9wrr7/PBwHATEt8eVYQ33Hh0MoE74cXxVkUbv4p/pZ.8h52	\N	\N	\N	\N	t	\N
\.
...
--
-- Name: users uniq_email; Type: CONSTRAINT; Schema: public; Owner: yash
--
...
--
-- Name: users uniq_username; Type: CONSTRAINT; Schema: public; Owner: yash
--
